Rails.application.configure do
  ...
  config.action_mailer.default_url_options = {
    host: 'https://taxistation.herokuapp.com'
  }
  ...
  config.cache_store = :redis_store if "redis://localhost:6379/0/cache"
  ...
  # config.active_job.queue_name_prefix = "taxi_station_#{Rails.env}"
