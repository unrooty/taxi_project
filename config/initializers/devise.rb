...
Devise.setup do |config|
  ...
  # config.secret_key =
  # 'e6ff64590c62a3e3fca67949bca9bd85a705c44f7b251507dcea25bb31914a3c67235ae771
  # f5bf5764018bc34dd95060686c0f2c5feed3fb1b72f2b3174a5d89'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = 'exampleemail@gmail.com'
  ...
  # passed to the find_for_authentication method
  # and considered in your model lookup.
  # For instance,
  ...
  # of your test suite dramatically.
  ...
  # config.pepper =
  # '5721e8d8b8d3804073e13f22683d4ec0cb5cae94c98ef39f60522e69e43
  # 439768f31ef2ad24976b024cd9ea5b662c23dba302838d27bfffe532ef4ad9a682e0e'
  ...
  #
  # Require the `devise-encryptable` gem
  # when using anything other than bcrypt
