class OrdersController < ApplicationController
  ...
  def index
    run Order::Index, params: params, current_user: current_user
  end

  def new
    result = Order::Create::Present.call(params: params)
  ...
  def edit
    result = Order::Update::Present.call(params: params,
                                         current_user: current_user)
    handle_successful(result)
  end
  ...
  def send_email_with_orders
    result = Order::SendEmailWithOrders.call(params: params,
                                             current_user: current_user)
    handle_successful(result) do
  ...
  def generate_orders_pdf
    result = Order::GeneratePdfWithOrders.call(params: params,
                                               current_user: current_user)
    handle_successful(result) do
